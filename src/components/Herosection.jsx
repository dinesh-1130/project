...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden font-['Lato']">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#7B941C]/80 via-transparent to-transparent z-10" />

      {/* Hero Content */}
      <div
        className="relative z-20 flex flex-col justify-center h-full px-6 sm:px-8 lg:px-20 pt-20 max-w-5xl text-white"
        data-aos="fade-up"
      >
